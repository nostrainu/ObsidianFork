...
function Library:CreateWindow(WindowInfo)
    ...
    if ShowFABBlock then
        ...
        Library:AddOutline(SearchContainer)
        ...
        UpdateMenu = function(Expand, Force)
            ...
            for idx, item in ipairs(MenuButtons) do
                ...
                if Expand then
                    ...
                    TweenService:Create(Btn.UIStroke, Library.TweenInfo, {
                        Transparency = 0
                    }):Play()
                    TweenService:Create(Btn.IconLabel, Library.TweenInfo, {
                        Size = UDim2.fromOffset(20, 20),
