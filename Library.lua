...
local Library = {
    ...
    Scheme = {
        ...
        OutlineColor = Color3.fromRGB(30, 30, 42),
...
function Library:CreateWindow(WindowInfo)
    ...
    if ShowFABBlock then
        ...
        local function FadeOut()
            ...
            if FABButton:FindFirstChildWhichIsA("UIStroke") then
                TweenService:Create(FABButton:FindFirstChildWhichIsA("UIStroke"), TweenInfo.new(0.8, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                    Transparency = FADE_OPACITY
                }):Play()
            end
        end
        ...
        local function FadeIn()
            ...
            if FABButton:FindFirstChildWhichIsA("UIStroke") then
                TweenService:Create(FABButton:FindFirstChildWhichIsA("UIStroke"), TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                    Transparency = 0
                }):Play()
            end
        end
