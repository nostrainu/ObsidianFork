...
function Library:CreateWindow(WindowInfo)
    ...
    if ShowFABBlock then
        ...
        if WindowInfo.PopCat then
            local closedAsset = WindowInfo.PopCatClosedType == "smirk" and "PopCatSmirkClosed" or "PopCatIdleClosed"
            FABIcon.Image = CustomImageManager.GetAsset(closedAsset)
