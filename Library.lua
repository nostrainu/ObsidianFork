    ...
    if ShowFABBlock then
        ...
        local function MakeFABDraggable(UI, DragFrame)
            ...
            DragFrame.InputBegan:Connect(function(Input)
                ...
                if UpdateMenu then
                    UpdateMenu(false) -- collapse menu on drag start
                end
        ...
        UpdateMenu = function(Expand)
            ...
            for idx, item in ipairs(MenuButtons) do
                ...
                local LabelStroke = item.LabelStroke
                ...
                if Expand then
                    ...
                    -- Fade in labels below buttons
                    TweenService:Create(Label, Library.TweenInfo, {
                        TextTransparency = 0
                    }):Play()
                    TweenService:Create(LabelStroke, Library.TweenInfo, {
                        Transparency = 0.5
                    }):Play()
                else
        ...
        local function BuildMenuButtons()
            ...
            for _, action in ipairs(Actions) do
                ...
                -- Labels below circular buttons (matching mockup)
                local Label = New("TextLabel", {
                    BackgroundTransparency = 1,
                    Position = UDim2.new(0.5, 0, 1, 4),
                    AnchorPoint = Vector2.new(0.5, 0),
                    Size = UDim2.new(0, 80, 0, 12),
                    Text = action.Name:upper(),
                    TextColor3 = "FontColor",
                    TextSize = 9,
                ...
                -- Click connection
                local item = { Button = Btn, Label = Label, LabelStroke = LabelStroke }
            ...
            if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                if MenuExpanded then
                    task.defer(function()
                        ...
                        local clickedInside = Library:MouseIsOverFrame(FABButton, Input.Position)
                        for _, item in ipairs(MenuButtons) do
