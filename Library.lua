    ...
    function Window:AddTab(...)
        ...
        function Tab:AddGroupbox(Info)
            ...
            do
                ...
                New("UIPadding", {
                    PaddingLeft = UDim.new(0, 12),
                    PaddingRight = UDim.new(0, Info.Collapsible and 32 or 12),
        ...
        function Tab:AddTabbox(Info)
            ...
            do
                ...
                TabboxButtons = New("Frame", {
                    BackgroundTransparency = 1,
                    Size = UDim2.new(1, Info.Collapsible and -28 or 0, 0, 34),
                    Parent = TabboxHolder,
                })
                New("UIListLayout", {
                    FillDirection = Enum.FillDirection.Horizontal,
            ...
            function Tabbox:SetCollapsed(Collapsed, Instant)
                ...
                if not Collapsed and ActiveTab then
                    ...
                    TargetHeight = (ListY / Library.DPIScale) + 49
                end
                ...
                if Collapsed then
                    if Instant then
                        ...
                        ResizeTween:Play()
                        task.delay(Library.TweenInfo.Time, function()
                            if Tabbox.Collapsed and Tabbox.ActiveTab then
